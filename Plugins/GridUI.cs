...
namespace SmartGridPlugin
{
    public partial class GridUI : Form
    {
        ...
        void AddDrawPolygon()
        {
            layerpolygons.Polygons.Add(poligonoInicial);

            layerpolygons.Polygons[0].Fill = Brushes.Transparent;

            foreach (var item in poligonoInicial.Points)
            {
        ...
        private void domainUpDown1_ValueChanged(object sender, EventArgs e)
        {
            ...
            lbl_area.Text = calcpolygonarea(poligonoInicial.Points).ToString("#") + " m^2";
